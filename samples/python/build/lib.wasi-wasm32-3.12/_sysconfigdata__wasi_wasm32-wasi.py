...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/opt/wasi-sdk/bin/wasm-ld -L/opt/wasix/lib -lwasix '
              '-L/opt/wasix/lib -lwasix',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '.wasm',
 ...
 'CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv -O3 -Wall '
           '-isystem /opt/wasix/include -isystem /opt/wasix/include',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '-fno-strict-aliasing',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-isystem /opt/wasix/include',
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-L/opt/wasix/lib -lwasix',
 ...
 'CONFIG_ARGS': "'-C' '--host=wasm32-unknown-wasi' "
                ...
                "'--with-build-python=/build/cpython/builddir/wasi/../build/python' "
                "'--disable-ipv6' 'build_alias=x86_64-pc-linux-gnux32' "
                "'host_alias=wasm32-unknown-wasi' 'CC=ccache "
                "/opt/wasi-sdk/bin/clang' 'CFLAGS=-isystem /opt/wasix/include' "
                "'LDFLAGS=-L/opt/wasix/lib -lwasix'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/cpython/builddir/wasi/coverage.info',
 'COVERAGE_REPORT': '/build/cpython/builddir/wasi/lcov-report',
 ...
 'EXE': '.wasm',
 'EXEMODE': 755,
 'EXENAME': '/usr/local/bin/python3.12.wasm',
 ...
 'FREEZE_MODULE': '/build/cpython/builddir/wasi/../build/python '
                  '../../Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/build/cpython/builddir/wasi/../build/python '
                            '../../Programs/_freeze_module.py',
 ...
 'HOSTRUNNER': 'wasmtime run --env PYTHONPATH=/$(shell realpath --relative-to '
               '/build/cpython/builddir/wasi/../.. '
               '/build/cpython/builddir/wasi)/$(shell cat pybuilddir.txt):/Lib '
               '--mapdir /::../.. --',
 ...
 'LDFLAGS': '-L/opt/wasix/lib -lwasix -L/opt/wasix/lib -lwasix',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.12.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/opt/wasi-sdk/bin/wasm-ld -L/opt/wasix/lib -lwasix '
             '-L/opt/wasix/lib -lwasix',
 'LDVERSION': '3.12',
 'LIBC': '',
 ...
 'LIBEXPAT_CFLAGS': '-I../../Modules/expat -Wsign-compare -Wunreachable-code '
                    '-DNDEBUG -g -fwrapv -O3 -Wall -isystem /opt/wasix/include '
                    '-isystem /opt/wasix/include -std=c11 -Wextra '
 ...
 'LIBMPDEC_CFLAGS': '-I../../Modules/_decimal/libmpdec -DCONFIG_32=1 -DANSI=1 '
                    ...
                    '-Wall -isystem /opt/wasix/include -isystem '
                    '/opt/wasix/include -std=c11 -Wextra -Wno-unused-parameter '
 ...
 'LIBPL': '/usr/local/lib/python3.12/config-3.12-wasm32-wasi',
 'LIBPYTHON': '',
 ...
 'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  '
                   ...
                   '_testinternalcapi  _testcapi  atexit  faulthandler  posix  '
 ...
 'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='wasmtime run --env "
                     ...
                     '/build/cpython/builddir/wasi/../.. '
                     '/build/cpython/builddir/wasi)/$(shell cat '
                     "pybuilddir.txt):/Lib --mapdir /::../.. --' "
                     '_PYTHON_PROJECT_BASE=/build/cpython/builddir/wasi '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/cpython/builddir/wasi/`cat '
                     'pybuilddir.txt`:)../../Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi '
                     '/build/cpython/builddir/wasi/../build/python',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/build/cpython/builddir/wasi/../build/python',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha256,sha512,sha3,blake2"',
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g '
                             '-fwrapv -O3 -Wall -isystem /opt/wasix/include '
                             '-isystem /opt/wasix/include -std=c11 -Wextra '
 ...
 'PY_CORE_LDFLAGS': '-L/opt/wasix/lib -lwasix -L/opt/wasix/lib -lwasix -z '
                    'stack-size=524288 -Wl,--stack-first '
                    '-Wl,--initial-memory=10485760',
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../Include',
 'PY_ENABLE_SHARED': 0,
 'PY_LDFLAGS': '-L/opt/wasix/lib -lwasix -L/opt/wasix/lib -lwasix',
 'PY_LDFLAGS_NODIST': '-z stack-size=524288 -Wl,--stack-first '
                      '-Wl,--initial-memory=10485760',
 'PY_LDFLAGS_NOLTO': '-L/opt/wasix/lib -lwasix -L/opt/wasix/lib -lwasix',
 ...
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -isystem /opt/wasix/include -isystem '
                        '/opt/wasix/include -std=c11 -Wextra '
                        '-Wno-unused-parameter -Wno-missing-field-initializers '
                        '-Wstrict-prototypes '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I../../Include/internal '
 ...
 'TESTPYTHON': "_PYTHON_HOSTRUNNER='wasmtime run --env PYTHONPATH=/$(shell "
               'realpath --relative-to /build/cpython/builddir/wasi/../.. '
               '/build/cpython/builddir/wasi)/$(shell cat pybuilddir.txt):/Lib '
               "--mapdir /::../.. --' "
               '_PYTHON_PROJECT_BASE=/build/cpython/builddir/wasi '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/cpython/builddir/wasi/`cat pybuilddir.txt`:)../../Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi '
               '/build/cpython/builddir/wasi/../build/python',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/build/cpython/builddir/wasi',
 'abs_srcdir': '/build/cpython/builddir/wasi/../..',
